 ...
 *
 * <p>
 * The standard version of <code>ActionServlet</code> is configured based
...
public class ActionServlet extends HttpServlet {
    ...
    protected void destroyModules() {
        ...
        while (keys.hasNext()) {
            ...
            PlugIn[] plugIns = (PlugIn[]) getServletContext().getAttribute(Globals.PLUG_INS_KEY
                    + config.getPrefix());
    ...
    private void handleValueRequiredException(String field, String configType,
        ...
        String errorMessage = internal.getMessage("configFieldRequired", field, configType,
                configName);
    ...
    protected void initModulePlugIns(ModuleConfig config)
        ...
        for (int i = 0; i < plugIns.length; i++) {
            try {
                plugIns[i] = (PlugIn) RequestUtils.applicationInstance(plugInConfigs[i]
                        .getClassName());
    ...
    protected ForwardConfig processForwardConfigClass(
        ...
        if (forwardConfig.getClass().equals(ActionForward.class)) {
            ...
            if (!baseConfig.getClass().equals(forwardConfig.getClass())) {
                ...
                try {
                    newForwardConfig = (ForwardConfig) RequestUtils.applicationInstance(
                            baseConfigClassName);
    ...
    protected ExceptionConfig processExceptionConfigClass(
        ...
        if (exceptionConfig.getClass().equals(ExceptionConfig.class)) {
            ...
            if (!baseConfig.getClass().equals(exceptionConfig.getClass())) {
                ...
                try {
                    newExceptionConfig = (ExceptionConfig) RequestUtils.applicationInstance(
                            baseConfigClassName);
    ...
    /**
     * <p>
     * Create (if needed) and return a new <code>Digester</code> instance
