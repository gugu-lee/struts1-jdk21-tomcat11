...
public class RequestProcessor {
    ...
    /**
     * <p>
     * The <code>ModuleConfiguration</code> with which we are
     * associated.
     * </p>
     */
    ...
    protected ActionForm processActionForm(HttpServletRequest request,
        ...
        ActionForm instance = RequestUtils.createActionForm(request, mapping, moduleConfig,
                servlet);
    ...
    protected void processForwardConfig(HttpServletRequest request,
        ...
        // If the forward can be unaliased into an action, then use the path of the
        // action
    ...
    protected ActionForward processException(HttpServletRequest request,
        ...
        try {
            ExceptionHandler handler = (ExceptionHandler) RequestUtils.applicationInstance(config
                    .getHandler());
    ...
    /**
     * <p>
     * If this request was not cancelled, and the request's {@link
    ...
    /**
     * <p>
     * Do a module relative forward to specified URI using request
     * dispatcher. URI is relative to the current module. The real URI is
     * compute by prefixing the module name.
     * </p>
     * <p>
     * This method is used
    ...
    /**
     * <p>
     * Do a module relative include to specified URI using request
     * dispatcher. URI is relative to the current module. The real URI is
     * compute by prefixing the module name.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Return the <code>ServletContext</code> for the web application in
