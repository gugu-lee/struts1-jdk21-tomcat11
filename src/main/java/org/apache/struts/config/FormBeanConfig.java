...
public class FormBeanConfig extends BaseConfig {
    ...
    protected void inheritFormProperties(FormBeanConfig config)
        ...
        for (int i = 0; i < baseFpcs.length; i++) {
            ...
            if (prop == null) {
                ...
                prop = (FormPropertyConfig) RequestUtils.applicationInstance(baseFpc.getClass()
                        .getName());
     ...
     * the information in this <code>FormBeanConfig</code>.
     * </p>
     *
     * <p>
     ...
     * throw a <code>NullPointerException</code> in this case.
     * </p>
     * <p>
     * TODO:
    ...
    /**
     * <p>
     * Checks if the given <code>ActionForm</code> instance is suitable for
     * use as an alternative to calling this <code>FormBeanConfig</code>
     * instance's <code>createActionForm</code> method.
     * </p>
     *
