...
public class ModuleConfigImpl extends BaseConfig implements Serializable,
     ...
     * the <code>actionId</code> property.
     * </p>
     */
    ...
    /**
     * <p>
     * Constructor for ModuleConfigImpl. Assumes default
     * configuration.
     * </p>
     *
     * @since Struts 1.2.8
    ...
    /**
     * <p>
     * Ad d a new <code>ActionConfig</code> instance to the set
    ...
    /**
     * <p>
     * Add a new <code>FormBeanConfig</code> instance to the set
     * associated with this module.
     * </p>
     *
     * @param config The new configuration instance to be added
    ...
    /**
     * <p>
     * Return the message resources configurations for this module. If
