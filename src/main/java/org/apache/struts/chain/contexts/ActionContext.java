...
public interface ActionContext extends Context {
     ...
     *                  to <code>APPLICATION_SCOPE</code>,
    ...
    /**
     * <p>
     * Return a <code>Map</code> of parameters submitted by the user as
    ...
    /**
     * <p>
     * Set the ActionForm instance which will carry any data submitted as
    ...
    /**
     * <p>
     * Set the include path which should be processed as part of
     * processing this request.
     * </p>
     *
