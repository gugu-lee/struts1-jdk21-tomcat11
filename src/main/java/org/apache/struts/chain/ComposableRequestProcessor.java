...
public class ComposableRequestProcessor extends RequestProcessor {
     ...
     * </p>
     */
    private static final Class[] SERVLET_ACTION_CONTEXT_CTOR_SIGNATURE = new Class[] {
    ...
    /**
     * <p>
     * The {@link CatalogFactory} from which catalog containing the the
     * base request-processing {@link Command} will be retrieved.
     * </p>
     */
    ...
    /**
     * <p>
     * The {@link Catalog} containing all of the available command chains
     * for this module.
     */
    ...
    /**
     * <p>
     * ActionContext class as cached by createActionContextInstance
     * method.
     * </p>
     */
    ...
    /**
     * <p>
     * Make sure that the specified <code>className</code> identfies a
     * class which can be found and which implements the
     * <code>ActionContext</code> interface.
     * </p>
     *
    ...
    /**
     * <p>
     * Provide the initialized <code>ActionContext</code> instance which
    ...
    /**
     * <p>
     * Set common properties on the given <code>ActionContext</code>
    ...
    /**
     * <p>
     * Set the <code>CatalogFactory</code> instance which should be used to
