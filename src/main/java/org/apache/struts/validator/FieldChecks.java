 ...
 * </p>
 * <p>
 * In general passing in a null or blank
...
public class FieldChecks implements Serializable {
     ...
     */
    private static MessageResources sysmsgs = MessageResources.getMessageResources(
    ...
    public static Object validateDate(Object bean, ValidatorAction va,
        ...
        String datePattern = Resources.getVarValue("datePattern", field, validator, request,
                false);

        if (GenericValidator.isBlankOrNull(datePattern)) {
            datePattern = Resources.getVarValue("datePatternStrict", field, validator,
                    request, false);
    ...
    public static boolean validateMaxLength(Object bean, ValidatorAction va,
        ...
        if (value != null) {
            try {
                String maxVar = Resources.getVarValue("maxlength", field, validator,
                        request, true);
                int max = Integer.parseInt(maxVar);
    ...
    public static boolean validateMinLength(Object bean, ValidatorAction va,
        ...
        if (!GenericValidator.isBlankOrNull(value)) {
            try {
                String minVar = Resources.getVarValue("minlength", field, validator,
                        request, true);
                int min = Integer.parseInt(minVar);
    ...
    public static boolean validateUrl(Object bean, ValidatorAction va,
        ...
        String allow2slashesVar = Resources.getVarValue("allow2slashes", field, validator, request,
                false);
        ...
        String nofragmentsVar = Resources.getVarValue("nofragments", field, validator, request,
                false);
    ...
    private static void processFailure(ActionMessages errors, Field field,
        ...
        // Log the error
        String logErrorMsg = sysmsgs.getMessage("validation.failed", validator,
