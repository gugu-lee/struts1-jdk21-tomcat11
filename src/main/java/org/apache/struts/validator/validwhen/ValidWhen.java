...
public class ValidWhen {
    ...
    public static boolean validateValidWhen(Object bean, ValidatorAction va,
        ...
        try {
            ...
            String logErrorMsg = sysmsgs.getMessage("validation.failed", "validwhen",
        ...
        try {
            ...
            String logErrorMsg = "ValidWhenLexer Error for field ' " + field.getKey() + "' - "
                    + ex;
        ...
        try {
            ...
            String logErrorMsg = "ValidWhenParser Error for field ' " + field.getKey() + "' - "
                    + ex;
