...
/**
 * <p>
 * This class implements the <code>MultipartRequestHandler</code>
...
public class CommonsMultipartRequestHandler implements MultipartRequestHandler {
     ...
     * instances to Struts <code>FormFile</code> instances.
     * </p>
     *
    ...
    public void handleRequest(HttpServletRequest request)
        ...
        DiskFileItemFactory factory = DiskFileItemFactory.builder().get(); // for javax
        // factory.setRepository(repository);
        // Create and configure a DIskFileUpload instance.
        JakartaServletDiskFileUpload upload = new JakartaServletDiskFileUpload(factory);
        // DiskFileItemFactory upload = new DiskFileItemFactory(factory);
     ...
     * element in the Struts config file.</li>
     * <li>The container-specified
     * temp dir, obtained from the <code>javax.servlet.context.tempdir</code>
     * servlet context attribute.</li>
     * <li>The temp dir specified by the
     * <code>java.io.tmpdir</code> system property.</li>
     * </ol>
     * 
     *
    ...
    static class CommonsFormFile implements FormFile, Serializable {
        ...
        /**
         * <p>
         * Returns the data for this file as a byte array. Note that this
